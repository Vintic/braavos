<cfoutput>
	...
	<html lang="en">
		<head>
			...
			<meta name="description" content="RealEstateView Agent Login">
			<!---
						CSS
			...
			<script src="https://kit.fontawesome.com/d2e91da188.js"></script>
			<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" />
			<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.9.1/jquery.modal.min.css" />
			<link rel="stylesheet" href="/javascripts/jquery/plugins/colorpicker/jquery.colorpicker.css">
			...
			#javascriptIncludeTag("jquery/plugins/colorpicker/jquery.colorpicker.js")#
	...
	--->
	#includePartial("/layouts/user/navigation")#
	...
	<!---
		Include Footer
	--->
	#includePartial("/layouts/user/footer")#
